...
public class ConfigUploadFileTest {

    @Test
    public void parse() {
        try {
            PushInfo pushInfo = JSON.parseObject(ConfigUploadFileTest.class.getResourceAsStream("/exec.json"), PushInfo.class);
    ...
    public void checkpassword(){
        ...
        try {
            pushInfo = JSON.parseObject(ConfigUploadFileTest.class.getResourceAsStream("/exec.json"), PushInfo.class);
